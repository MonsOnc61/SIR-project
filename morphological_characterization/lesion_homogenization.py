...
# 1) Chemins
# ======================
mask_path = "MSLesSeg_Dataset/train/P1/T1/P1_T1_MASK.nii.gz"              # masque binaire des lésions (0/1)
output_path = "Normalization/P1_T1_LESIONS_SORTED.nii.gz"  # sortie : labels normalisés
